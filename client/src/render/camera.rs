...
pub fn update_camera(
    mut camera: Single<&mut Transform, (With<Camera2d>, Without<crate::core::player::Player>)>,
    player: Single<&Transform, (With<crate::core::player::Player>, Without<Camera2d>)>,
    time: Res<Time>,
) {
...
pub fn move_player(
    mut player: Single<&mut Transform, With<crate::core::player::Player>>,
    time: Res<Time>,
